...
<body class="bg-gray-200 font-sans leading-normal tracking-normal">
	...
	<!--Header-->
	<div class="w-full m-0 p-0 bg-cover bg-bottom" style="background-image:url('https://w.wallhaven.cc/full/0q/wallhaven-0qever.jpg'); height: 60vh; max-height:460px;">
		<div class="container max-w-4xl mx-auto pt-16 md:pt-32 text-center break-normal">
			<!--Title-->
			<p class="text-white font-extrabold text-3xl md:text-5xl">
				<?php $this->options->title(); ?>
			</p>
			<p class="text-xl md:text-2xl text-gray-500"><?php $this->options->description(); ?></p>
		</div>
	</div>
	...
	<div class="container px-4 md:px-0 max-w-6xl mx-auto -mt-32">
		...
		<div class="mx-0 sm:mx-6">
				...
				<div class="container mx-auto flex items-center">
					...
					<div class="flex w-1/2 pl-4 text-sm">
						<ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
							<li class="mr-2">
								<a class="inline-block py-2 px-2 text-white no-underline hover:underline" href="<?php $this->options->siteUrl(); ?>">首页</a>
							</li>
							<li class="mr-2">
			...
			<div class="bg-gray-200 w-full text-xl md:text-2xl text-gray-800 leading-normal rounded-t">
				<?php if ($id = $this->options->exhPostId) :
					$article = getArticleById($id);
					$pic = $article->fields->picture ? $article->fields->picture : "https://source.unsplash.com/collection/494263/800x600";
					// var_dump($article);
					?>
					<!--Lead Card-->
					<div class="flex h-full bg-white rounded overflow-hidden shadow-lg">
						<a href="post.html" class="flex flex-wrap no-underline hover:no-underline">
							<div class="w-full  rounded-t">
								<img src="<?php echo $pic; ?>" class="h-full w-full shadow">
							</div>
							<div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
								<div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
									<div class="w-full text-gray-600 text-xs md:text-sm pt-6 px-6"><?php $article->category(','); ?></div>
									<div class="w-full font-bold text-xl text-gray-900 px-6"><?php $article->title(); ?></div>
									<p class="text-gray-800  text-base px-6 mb-5 pt-2">
										<?php $article->excerpt(100, '...'); ?>
									</p>
								</div>

								<div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-lg p-6">
									<div class="flex items-center justify-between">
										<img class="w-8 h-8 rounded-full mr-4 avatar" data-tippy-content="<?php $article->author(); ?>" src="<?php echo Typecho_Common::gravatarUrl($article->author->mail, 64, 0, ""); ?>" alt="Avatar of Author">
										<p class="text-gray-600 text-xs md:text-sm"><?php $article->dateWord(); ?></p>
									</div>
								</div>
							</div>
					...
					<!--/Lead Card-->
				<?php endif; ?>
				<h1 class="extra-light text-4xl pt-6">最近文章</h1>
				<!--Posts Container-->
				...
				<h1 class="extra-light text-4xl pt-6">最近日记</h1>
				<div class="flex flex-wrap justify-between -mx-6">
					<!--1/2 col -->
